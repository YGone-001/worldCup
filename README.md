...
- **比赛胜平负预测**：结合球队强度、FIFA 排名、Elo、阵容身价、近期状态、历史经验、伤病和休息天数，生成主胜/平局/客胜概率。
- **比分与进球预测**：基于泊松分布计算预期进球、常见比分、大小球倾向和悬念指数。
- **赔率融合与价值分析**：可接入 1X2 赔率，将市场隐含概率按权重并入模型，并输出 EV 与 Kelly 仓位参考。
- **比赛详情页**：查看单场比赛双方实力、关键球员、伤病、模型概率、热门比分和赔率信息。
